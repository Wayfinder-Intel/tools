/**
 * Wayfinder — Facebook Friends Ingester
 * Version: 1.0
 * Date: 2026-05-22
 *
 * USAGE:
 *   Create a new bookmark in Chrome. Set the URL to the contents of
 *   facebook-friends-v1.0.min.js (the single-line minified version).
...
(function () {
  try {
    ...
    cd.innerHTML =
      '<div class="h"><span class="t">Wayfinder \u2014 Facebook Friends v1.0</span><button class="btn cb" id="cl">Close</button></div>' +
      '<div class="g">' +
