 ...
 *   instagram-profile-v1.12.min.js.
...
(function () {
  try {
    ...
    cd.innerHTML =
      '<div class="h"><span class="t">Wayfinder Connect \u2014 Instagram Profile Ingester v1.12</span><button class="btn cb" id="cl">Close</button></div>' +
